...
The public Process Architecture v0.6 separately documents the V5 target flow and evidence tiers. It does not overwrite current-production evidence, and V5 code/test evidence does not automatically imply dogfood activation, durability, or production deployment.
